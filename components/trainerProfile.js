...
const trainerProfile = (props) => {
  return (
    <div className="w-76 h-76 p-6 flex flex-col justify-center">
      <h3 className="uppercase font-bold text-red-600">{props.name}</h3>
      ...
      <div className="flex items-center mt-3">
        ...
        >
          <FontAwesomeIcon 
            icon={['fab', 'facebook-f']}
            className={props.socialMedia.facebook ? 'h-5 w-5 mr-4 fill-current text-red-500' : 'h-5 w-5 mr-4'}
          />
        </a>
        <a 
        ...
        >
          <FontAwesomeIcon 
            ...
            className={props.socialMedia.googlePlus ? 'h-8 w-8 mr-4 fill-current text-red-500' : 'h-8 w-8 mr-4'}
          />
        </a>
        <a 
        ...
        >
          <FontAwesomeIcon 
            icon={['fab', 'twitter']}
            className={props.socialMedia.twitter ? 'h-6 w-6 mr-4 fill-current text-red-500' : 'h-6 w-6 mr-4'}
          />
        </a>
        <a 
          ...
          <FontAwesomeIcon 
            icon={['fab', 'instagram']}
            className={props.socialMedia.instagram ? 'h-6 w-6 mr-4 fill-current text-red-500' : 'h-6 w-6 mr-4'}
          />
        </a>
      </div>
    </div>
