      ...
      <section className="mb-32 flex flex-col ml-10 xl:ml-0">
        <nav className="flex flex-col xl:flex-row items-baseline justify-between">
          ...
          <div className="flex items-baseline mr-56">
            <a href="#" onClick={(e) => filterClassCategory(e, 'all')} className={classCategory === 'all' ? 'mx-2 md:mx-4 pb-2 px-4 border-b-2 border-red-600' : 'mx-2 md:mx-4 px-4'}>All</a>
            <a href="#" onClick={(e) => filterClassCategory(e, 'men')} className={classCategory === 'men' ? 'mx-2 md:mx-4 pb-2 px-4 border-b-2 border-red-600' : 'mx-2 md:mx-4 px-4'}>Mens</a>
            <a href="#" onClick={(e) => filterClassCategory(e, 'women')} className={classCategory === 'women' ? 'mx-2 md:mx-4 pb-2 px-4 border-b-2 border-red-600' : 'mx-2 md:mx-4 px-4'}>Womens</a>
          </div>
        </nav>
